...
class buttons:
    ...
    def __init__(self, window):
        buttonLoadFile = Button(window, text="Load File", width=10, height=2,command=loadFile)
        buttonLoadFile.place(relx=0, x=50, y=50)
        buttonSearchMovie = Button(window, text="Search Movie", width=10, height=2,command=searchMovie)
        buttonSearchMovie.place(relx=0, x=150, y=50)
        buttonNewMovie = Button(window, text="New Movie", width=10, height=2,command=newMovie)
